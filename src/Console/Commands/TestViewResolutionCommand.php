...
{
    protected $signature = 'admins:test-views';
    protected $description = 'Test view resolution for Admins module';

    public function handle()
    {
        $this->info('🔍 Testing View Resolution for Admins Module...');
        ...
        foreach ($testViews as $viewName) {
            ...
            $namespaces = [
                'admins-module::' . $viewName => 'Module View',
                'admin::' . $viewName => 'Package View',
            ];
        ...
        $controller = new \Modules\Admins\app\Http\Controllers\Admin\AdminManagerController();
        ...
        $this->info("\n📋 View Loading Order:");
        $this->info("1. admins-module:: (Module views - highest priority)");
        $this->info("2. admin:: (Package views - fallback)");
        
        $this->info("\n💡 Tips:");
        $this->info("- Edit views in Modules/Admins/resources/views/ to use module views");
